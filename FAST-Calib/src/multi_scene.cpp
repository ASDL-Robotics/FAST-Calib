...
{
    // Supports lines like: lidar_centers: {x,y,z} {x,y,z} {x,y,z} {x,y,z}
    std::regex brace_re("\\{([^\\}]*)\\}");
...
int main(int argc, char** argv)
{
    ...
    // Read all lines from the intermediate results file
    ...
    // Parse all blocks (3 lines each: time + lidar_centers + qr_centers)
